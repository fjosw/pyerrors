...
def remove_outliers(old_obs, threashold=5.0, verbose=True, exception_at=None):
    ...
    Args:
        ...
        threashold (float, optional): The threashold for a confoguration to count as faulty, given in standard deviations. Defaults to 5.0.
    ...
    for name in old_obs.names:
        ...
        reduced_idx = list(np.array(old_obs.idl[name])[abs(old_obs.deltas[name] - median) < threashold * sigma])
